<template>
	<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'" class="uni-list-item" @click="onClick">
		<view class="uni-list-item__container">
			...
			<view v-if="showBadge || showArrow || showSwitch || showImg || showText" class="uni-list-item__extra">
				<view v-if="showImg" class="thisImg">
					<image class="icon" :src="img" mode="aspectFill"></image>
				</view>
				<view class="thisText" v-if="showText">
					{{text}}
				</view>
...
<style>
	...
	.thisImg{width: 80upx;height: 80upx;border-radius: 50%;overflow: hidden;background-color: #999;}
