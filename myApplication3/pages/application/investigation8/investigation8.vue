	...
	<view class="investigation">
		...
		<view class="investigation-form form1">
			...
			<view class="item" >
				...
				<view class="field">{{dataInfo.dirver}}</view>
			</view>
			<view class="item" >
				<view class="text">车牌号 : </view>
				<view class="field">{{dataInfo.carNumber}}</view>
			</view>
			<view class="item" >
				<view class="text">用车事由 : </view>
				<view class="field">{{dataInfo.carReason}}</view>
			</view>
		</view>
...
<style>
@import "../investigation6/investigation6.css"
</style>
