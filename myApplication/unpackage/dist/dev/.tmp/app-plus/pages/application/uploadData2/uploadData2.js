...
var _default = { data: function data() {return { image: 'url(../../../static/img/img1.png)', image2: 'url(../../../static/img/img2.png)', uploadimg1: { uri: "", name: "request1" }, uploadimg2: { uri: "", name: "request2" }, num: "", mainFlag: "", mainId: "", doc_id: "", pdid: "", piid: "", tiid: "", nodecode: "", request: [], ishas: 0 };
  ...
  methods: {
    ...
    doKeep: function doKeep() {
      ...
      var that = this;
      var url = "http://".concat((0, _config.baseIp)(), "/ams/system/distribute.htm?module=uploadFile_YD&userId=").concat((0, _service.getUserInfo)().userId, "&mainId=").concat(that.mainId, "&mainFlag=exam&mate=").concat(that.num);
      ...
      uni.uploadFile({
        ...
        success: function success(res) {
          ...
          if (data.code == 1) {
            ...
            setTimeout(function () {
              uni.navigateTo({ url: "/pages/application/investigation2/investigation2?acceptid=".concat(that.mainId, "&doc_id=").concat(that.doc_id, "&pdid=").concat(that.pdid, "&piid=").concat(that.piid, "&tiid=").concat(that.tiid, "&nodecode=").concat(that.nodecode, "&isUp=true") });
            }, 3000);

          }
        },
        fail: function fail(err) {
          console.log(err, " at pages\\application\\uploadData2\\uploadData2.vue:105");
        } });
