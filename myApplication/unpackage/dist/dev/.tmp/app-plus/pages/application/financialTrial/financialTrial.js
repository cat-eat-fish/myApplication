    ...
    submitAcce: function submitAcce() {
      if (!this.ishold) {
        uni.showModal({
          ...
          success: function success(res) {
            if (res.confirm) {
              console.log('用户点击确定', " at pages\\application\\financialTrial\\financialTrial.vue:168");
            } else if (res.cancel) {
              console.log('用户点击取消', " at pages\\application\\financialTrial\\financialTrial.vue:170");
            }
          } });
        ...
        uni.showModal({
          ...
          success: function success(res) {
            if (res.confirm) {
              console.log('用户点击确定', " at pages\\application\\financialTrial\\financialTrial.vue:180");
            } else if (res.cancel) {
              console.log('用户点击取消', " at pages\\application\\financialTrial\\financialTrial.vue:182");
            }
          } });
        ...
        uni.request({
          ...
          fail: function fail(err) {
            console.log(err, " at pages\\application\\financialTrial\\financialTrial.vue:203");
          } });
