...
}var _default =
{
  ...
  methods: {
    ...
    getInfo: function getInfo() {
      var that = this;
      var url = "http://".concat((0, _config.baseIp)(), "/ams/system/distribute.htm?module=ZXInfo&user_id=").concat((0, _service.getUserInfo)().userId, "&acceptid=").concat(that.acceptid, "&doc_id=").concat(that.doc_id, "&pdid=").concat(that.pdid, "&pdid=").concat(that.pdid, "&tiid=").concat(that.tiid, "&piid=").concat(that.piid);
      // console.log(url)
      uni.request({
        url: url,
        success: function success(res) {
          var data = res.data;
          console.log(data, " at pages\\application\\investigation2\\investigation2.vue:445");
    ...
    getUpload: function getUpload() {
      var that = this;
      uni.request({
        url: "http://".concat((0, _config.baseIp)(), "/ams/system/distribute.htm?module=zllb_YD&mainId=").concat(that.acceptid),
        success: function success(res) {
          var data = res.data;
          console.log(data, " at pages\\application\\investigation2\\investigation2.vue:460");
    ...
    resultPath1: function resultPath1(e) {
      this.path1 = "file://".concat(e);
      this.uploadimg1.uri = "file://".concat(e);
      this.showFileName1 = "".concat(this.path1.substring(0, 9), "...").concat(this.path1.substr(-20));
    },
    //选择文件  2.
    ...
    resultPath2: function resultPath2(e) {
      this.path2 = "file://".concat(e);
      this.uploadimg2.uri = "file://".concat(e);
      this.showFileName2 = "".concat(this.path2.substring(0, 9), "...").concat(this.path2.substr(-20));
      console.log(this.path2, this.showFileName2, " at pages\\application\\investigation2\\investigation2.vue:484");
    },
    // 上传文件
    uploadF1: function uploadF1() {
      ...
      var that = this;
      var url = "http://".concat((0, _config.baseIp)(), "/ams/system/distribute.htm?module=uploadFile_YD&userId=").concat((0, _service.getUserInfo)().userId, "&mainId=").concat(that.acceptid, "&mainFlag=cred&mate=").concat(that.num);
      ...
      uni.uploadFile({
        ...
        fail: function fail(err) {console.log(err, " at pages\\application\\investigation2\\investigation2.vue:516");} });
    ...
    uploadF2: function uploadF2() {
      ...
      uni.uploadFile({
        ...
        fail: function fail(err) {console.log(err, " at pages\\application\\investigation2\\investigation2.vue:547");} });
    ...
    goupload: function goupload() {
      ...
      uni.navigateTo({ url: "/pages/application/uploadData2/uploadData2?isstudy=".concat(isstudy, "&mainId=").concat(that.acceptid) });
    },
    // 选择时间
    ...
    getNodeList: function getNodeList() {
      ...
      uni.request({
        ...
        success: function success(res) {
          var data = res.data;
          console.log(data, " at pages\\application\\investigation2\\investigation2.vue:627");
    ...
    radioChange4: function radioChange4(evt) {
      for (var i = 0; i < this.items4.length; i++) {
        if (this.items4[i].value === evt.target.value) {
          this.current4 = i;
          console.log(this.nodeListInfo[i], " at pages\\application\\investigation2\\investigation2.vue:650");
    ...
    // 退回
    back: function back() {
      console.log(this.tokenId, " at pages\\application\\investigation2\\investigation2.vue:774");
      // 验证
      if (this.tokenId === "") {
      ...
      console.log(url, " at pages\\application\\investigation2\\investigation2.vue:783");
      uni.showLoading({ title: "退回中", mask: true });
      uni.request({
        url: url,
        success: function success(res) {
          var data = res.data;
          console.log(res, " at pages\\application\\investigation2\\investigation2.vue:789");
          if (data.code == 1) {
            uni.hideLoading();
            uni.showToast({ title: data.message, mask: true, duration: 3000 });
            setTimeout(function () {
    ...
    submitAcce: function submitAcce() {
      ...
      var that = this;
      var url = "http://".concat((0, _config.baseIp)(), "/ams/system/distribute.htm?module=approveZX&userId=").concat((0, _service.getUserInfo)().userId, "&acceptId=").concat(that.acceptid, "&tiid=").concat(that.tiid, "&mainId=").concat(that.acceptid, "&pdId=").concat(that.pdid, "&docId=").concat(that.doc_id, "&comment=").concat(that.comment, "&status=").concat(that.status, "&piId=").concat(that.piid);
      ...
      uni.request({
        ...
        fail: function fail(err) {
          console.log(err, " at pages\\application\\investigation2\\investigation2.vue:860");
        } });
