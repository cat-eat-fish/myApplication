...
var _default = { data: function data() {return { dataInfo: [// {id:0,name:"收回再贷",stateTime:"2019-02-19 10:20:36",originator:"张三"},
      ] };}, onLoad: function onLoad() {var that = this;var userInfo = (0, _service.getUserInfo)();uni.request({ url: "http://192.168.3.125:8080/ams/system/distribute.htm?module=pending&user_id=".concat(userInfo.userId), success: function success(res) {var data = res.data;that.dataInfo = data.object;console.log(data.object);} });}, methods: { goPage: function goPage(e) {uni.navigateTo({ url: "/pages/application/investigation/investigation?acceptid=".concat(e.acceptid, "&doc_id=").concat(e.doc_id, "&pdid=").concat(e.pdid, "&piid=").concat(e.piid, "&tiid=").concat(e.tiid) });} } };exports.default = _default;
