	...
	<view class="investigation">
		...
		<view class="investigation-form form1">
			...
			<view class="item" >
				...
				<view class="field">{{dataInfo.product_name}}</view>
			</view>
			<view class="item" >
				<view class="text">流资合同号 : </view>
				<view class="field">{{dataInfo.contract_no}}</view>
			</view>
			<view class="item" >
				<view class="text">业务品种金额 : </view>
				<view class="field">{{dataInfo.category_amount}}</view>
			</view>
			<view class="item" >
				<view class="text">可用金额 : </view>
				<view class="field">{{dataInfo.amount_available}}</view>
			</view>
			<view class="item" >
				<view class="text">申请金额 : </view>
				<view class="field">{{dataInfo.apply_amount}}</view>
			</view>
			<view class="item" >
				<view class="text">币种 : </view>
				<view class="field">{{dataInfo.currency}}</view>
			</view>
			<view class="item" >
				<view class="text">申请期限 : </view>
				<view class="field">{{dataInfo.application_period}}</view>
			</view>
			<view class="item" >
				<view class="text">贷款性质 : </view>
				<view class="field">{{dataInfo.nature_loan}}</view>
			</view>
			<view class="item" >
				<view class="text">贷款方式 : </view>
				<view class="field">{{dataInfo.loan}}</view>
			</view>
			<view class="item" >
				<view class="text">贷款投向 : </view>
				<view class="field">{{dataInfo.loans_to}}</view>
			</view>
			<view class="item" >
			...
			<view class="item" >
				<view class="text">贷款种类 : </view>
				<view class="field">{{dataInfo.loan_types}}</view>
			</view>
			<view class="item" >
				<view class="text">用途明细 : </view>
				<view class="field">{{dataInfo.use_detail}}</view>
			</view>
			<view class="item" >
				<view class="text">还款方式 : </view>
				<view class="field">{{dataInfo.reimbursement_means}}</view>
			</view>
			<view class="item" >
				<view class="text">还款来源 : </view>
				<view class="field">{{dataInfo.source_repayment}}</view>
			</view>
			<view class="item" >
				<view class="text-l">结息方式 : </view>
				<view class="text-r">{{dataInfo.interest_settlement_way}}</view>
			</view>
			<view class="item" >
				<view class="text">退出措施 : </view>
				<view class="field">{{dataInfo.exit_measures}}</view>
			</view>
			<view class="item" >
				<view class="text">退出期限 : </view>
				<view class="field">{{dataInfo.exit_deadline}}</view>
			</view>
			<view class="item" >
				<view class="text">营销人 : </view>
				<view class="field">{{dataInfo.market_per}}</view>
			</view>
			<view class="item" >
				<view class="text">是否营销贷款 : </view>
				<view class="field">{{dataInfo.is_marketing_loan == 1 ? '是' : '否'}}</view>
			</view>
			<view class="item" >
				<view class="text">是否社团贷款 : </view>
				<view class="field">{{dataInfo.is_corporate_loan == 1 ? '是' : '否'}}</view>
			</view>
			<view class="item" >
				<view class="text">是否存量贷款 : </view>
				<view class="field">{{dataInfo.is_stock_loans == 1 ? '是' : '否'}}</view>
			</view>
			<view class="item">
		...
		<view class="investigation-title"  v-if="inve == '分网点审议（一般新增）' && !thistp  || inve == '县审议' && !thistp">审议投票</view>
		<view class="investigation-form form1"  v-if="inve == '分网点审议（一般新增）' && !thistp || inve == '县审议' && !thistp">
			<view class="item">
		...
		<view class="investigation-form form2">
			...
			<view v-if="inve == '分网点审查（一般新增）'">
				<view class="item">
					<view class="text">分网点审查审批结果 : </view>
					<view class="field ra">
				...
				<view class="item text" >
					<view class="text">分网点审查审批意见 : </view>
					<view class="field textarea">
			...
			<view v-if="inve == '分网点审议（一般新增）'">
				<view class="item">
					<view class="text">分网点审议结果 : </view>
					<view class="field ra">
						<radio-group class="group" @change="radioChange">
							<label class="uni-list-cell uni-list-cell-pd" v-for="(item, index) in items" :key="index">
								<view>
				...
				<view class="item text" >
					<view class="text">分网点审议意见 : </view>
					<view class="field textarea">
						<textarea class="textarea-t" v-model="comment"  auto-height />
					</view>
				</view>
				<view class="item">
					<view class="text">投票结果 : </view>
					<view class="field">
						{{votiResult}}
					</view>
				</view>
			</view>
			<view v-if="inve == '分网点审批（一般新增）'">
				<view class="item">
					<view class="text">分网点审批结果 : </view>
					<view class="field ra">
						<radio-group class="group" @change="radioChange">
							<label class="uni-list-cell uni-list-cell-pd" v-for="(item, index) in items" :key="index">
								<view>
			...
			<view v-if="inve == '县审批'">
				...
				<view class="item text" >
					<view class="text">县审批意见 : </view>
					<view class="field textarea">
						<textarea class="textarea-t" v-model="comment"  auto-height />
					</view>
				</view>
			</view>
			<view v-if="inve == '分网点批复确认'">
				<view class="item">
					<view class="text">分网点审批结果 : </view>
					<view class="field ra">
						<radio-group class="group" @change="radioChange">
...
<script>
	...
	export default {
		...
		onLoad(e){
			...
			var url = `http://${baseIp()}/ams/system/distribute.htm?module=informationYX_YD&user_id=${getUserInfo().userId}&acceptid=${e.acceptid}&pdid=${e.pdid}&tiid=${e.tiid}&piid=${e.piid}&docid=${that.doc_id}`;
			console.log(url)
			uni.request({
				url,
				success(res){
		...
		methods:{
			...
			doVote(){
				...
				var that = this,
					url = `http://${baseIp()}/ams/system/distribute.htm?module=saveVote2_YD&userId=${getUserInfo().userId}&status=${that.votiStatus}&comment=${that.votiOpinion}&taskInstanceId=${that.tiid}&acceptId=${that.acceptid}&docId=${that.doc_id}&tokenName=${that.inve}&pdid=${that.pdid}&nodeCode=${that.nodecode}`;
				console.log(url)
				uni.request({
					url,
					success(res){
			...
			submitAcce(){
				var that = this;
				var url =`http://${baseIp()}/ams/system/distribute.htm?module=approveYX_YD&userId=${getUserInfo().userId}&taskInstanceId=${that.tiid}&mainId=${that.mianId}&pdId=${that.pdid}&piId=${that.piid}&docId=${that.doc_id}&comment=${that.comment}&status=${that.status}&userIds=${that.inveder}&acceptId=${that.acceptid}`;
				...
				if(this.inve == "投票"){
					...
					var that = this;
					var url = `http://${baseIp()}/ams/system/distribute.htm?module=saveVote2_YD&userId=${getUserInfo().userId}&status=${that.status}&comment=${that.comment}&taskInstanceId=${that.tiid}&acceptId=${that.acceptid}&docId=${that.doc_id}&tokenName=${that.inve}&pdid=${that.pdid}&nodeCode=${that.nodecode}`;
